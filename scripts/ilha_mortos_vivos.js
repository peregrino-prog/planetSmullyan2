...
fetch(`../linguas/falas_mortos_vivos_${linguaAtual}.json`)
...
//////////////////////////////////////////////
    ...
    if (indiceAtual === 3) {
        iniciarQuestionario("situacao28");
      }
      
      else if (indiceAtual === 6) {
        iniciarQuestionario("situacao29");
      } 
      ...
      const indicesComSlots = [3, 6, 15, 21]; // actualizar onde aparecem os slots na linha de história 2/3
    ...
    document.getElementById("verificar").style.display = [3, 6, 15, 21].includes(indiceAtual)
      ? "block"
      : "none";
