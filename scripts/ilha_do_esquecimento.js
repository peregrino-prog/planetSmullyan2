...
fetch(`../linguas/falas_esquecimento_${linguaAtual}.json`)
...
//////////////////////////////////////////////
    ...
    if (indiceAtual === 2) {
        iniciarQuestionario("situacao46");
      } 
      ...
      const indicesComSlots = [2, 11, 15, 21]; // actualizar onde aparecem os slots na linha de história 2/3
    ...
    document.getElementById("verificar").style.display = [2, 11, 15, 21].includes(indiceAtual)
      ? "block"
      : "none";
