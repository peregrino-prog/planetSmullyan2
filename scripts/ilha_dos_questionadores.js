...
fetch(`../linguas/falas_questionadores_${linguaAtual}.json`)
...
//////////////////////////////////////////////
    ...
    if (indiceAtual === 3) {
        iniciarQuestionario("situacao24");

      } else if (indiceAtual === 7) {
        iniciarQuestionario("situacao25");

      } else if (indiceAtual === 11) {
        iniciarQuestionario("situacao26");

      } else if (indiceAtual === 21) {
        iniciarQuestionario("situacao23");
      } 

      const indicesComSlots = [3, 7, 11, 21]; // actualizar onde aparecem os slots na linha de história 2/3
    ...
    document.getElementById("verificar").style.display = [3, 7, 11, 21].includes(indiceAtual)
      ? "block"
      : "none";
